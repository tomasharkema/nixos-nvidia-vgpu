    ...
    name = "driver-compile";
      nativeBuildInputs = [ pkgs.p7zip pkgs.unzip pkgs.coreutils];
        ...
        vgpu_unlock_src = pkgs.fetchFromGitHub {
          ...
          hash = "sha256-0qcwn9yx0rd7zksmq1blp5rjzhlzci1rs0bifpsa9ly0rh3xdh75";
        ...
        original_driver_src = pkgs.fetchurl {
          ...
          hash = "sha256-17av8nvxzn5af3x6y8vy5g6zbwg21s7sq5vpa1xc6cx8yj4mc9xm";
        };
        vgpu_driver_src = pkgs.fetchurl {
          ...
          hash = "sha256-1x0xcn8lk6q53z7rdyv785x0xl0z5mx581kmy96qzfnim2ac22sn";
        };
        buildPhase = ''
          mkdir -p $out
          cd $TMPDIR
